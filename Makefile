...
info:
	@echo "=== Docker開発環境情報 ==="
	@echo "ウェブサイト: http://localhost:$${NGINX_PORT:-80}"
	@echo ""
	@echo "データベース管理:"
...
profiles-help:
	...
	@echo "   COMPOSE_PROFILES=nginx,php,mysql,phpmyadmin"
	@echo ""
	@echo "2. 設定例："
	@echo "   # 基本的なPHP開発環境"
	@echo "   COMPOSE_PROFILES=nginx,php,mysql,phpmyadmin"
	@echo ""
	@echo "   # メール送信テストを含む"
	@echo "   COMPOSE_PROFILES=nginx,php,mysql,phpmyadmin,mailhog"
	@echo ""
	@echo "   # Redis使用のアプリケーション"
	@echo "   COMPOSE_PROFILES=nginx,php,mysql,redis,redis-commander"
	@echo ""
	@echo "   # 外部公開が必要な場合"
	@echo "   COMPOSE_PROFILES=nginx,php,mysql,ngrok"
	@echo ""
	@echo "   # ファイルストレージを含む"
	@echo "   COMPOSE_PROFILES=nginx,php,mysql,minio"
	@echo ""
	@echo "   # 全サービス"
	@echo "   COMPOSE_PROFILES=nginx,php,mysql,phpmyadmin,mailhog,redis,adminer,redis-commander,mailpit,minio,ngrok"
	@echo ""
